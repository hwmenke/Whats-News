...
class OverlayPackPersistenceTests(unittest.TestCase):
    ...
    def test_storage_keys_defaults_and_get_set_hooks(self):
        ...
        vwap_snip = html[vwap_idx : vwap_idx + 360]
        self.assertIn('aria-pressed="false"', vwap_snip)
        ...
        gap_snip = html[gap_idx : gap_idx + 460]
        self.assertIn('aria-pressed="false"', gap_snip)
        self.assertNotIn("active-gap", gap_snip)
