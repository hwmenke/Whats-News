...
class BoardRegistryTests(unittest.TestCase):
    ...
    def test_catalog_api_shape(self):
        ...
        self.assertEqual(body["theme"], "visual_v3")
        ...
        with open("styles/theme.css", encoding="utf-8") as fh:
            theme = fh.read()
        self.assertIn("#1e211e", theme)
        self.assertIn("#90fc95", theme)
        self.assertIn("Fraunces", theme)
        self.assertIn("--paper:", theme)
    ...
    def test_surfaces_wire_customize_and_theme(self):
        ...
        self.assertIn("Fraunces", blob)
        self.assertIn("#90fc95", blob)
        self.assertIn("IBM Plex Mono", blob)
        self.assertIn("visual-v3", blob)
