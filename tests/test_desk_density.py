...
class DeskDensityTests(unittest.TestCase):
    ...
    def test_book_surfaces_split(self):
        ...
        self.assertIn("DeskSpace.inset, DeskSpace.headerContent, DeskSpace.inset", dart)
        self.assertNotIn("fromLTRB(20, 8, 20, 24)", dart)
        self.assertNotIn("fontSize: 64", dart)
        self.assertNotIn("SingleChildScrollView(", dart[dart.find("_pnlSlivers"):dart.find("_riskSlivers")])
