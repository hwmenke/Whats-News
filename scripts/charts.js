...
// ATR Stop live in spy_rs.js / news_markers.js / vwap.js / last_price.js /
...
function applySavedOverlays() {
    ...
    // No key → user never toggled. Keep defaults (vs-SPY / News / VWAP stay off; Last too; ATR Stop too).
    if (!saved) {
        syncOverlayPills();
        return;
    }
