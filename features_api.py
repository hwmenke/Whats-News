...
# indicator helpers + swing engine live in swing_core (shared with jeff_scanner).
# Aliased to the historical private names so existing routes are unchanged.
import swing_core
import jeff_scanner
...
@features_bp.route("/api/jeff-scan", methods=["GET"])
def get_jeff_scan():
